    ...
    <div className="space-y-6 pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <form onSubmit={handleSave} className="lg:col-span-2 space-y-6">
          ...
          <div className="rounded-2xl p-6 sm:p-8 bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 shadow-sm space-y-5 transition-colors">
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-xs font-bold text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-slate-700 transition-colors"
              >
                Add Service
              </button>
            </div>
          ...
          <div className="rounded-2xl p-6 sm:p-8 bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 shadow-sm space-y-4 transition-colors">
            <h3 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider flex items-center gap-2 border-b border-slate-100 dark:border-slate-800 pb-3">
            ...
            <div className="text-xs space-y-1.5">
              <textarea
                ...
                className="w-full bg-slate-50 dark:bg-[#0B1120] border border-slate-200 dark:border-slate-800 rounded-xl p-3.5 text-slate-900 dark:text-slate-200 focus:border-teal-500 dark:focus:border-cyan-500 focus:outline-none font-mono leading-relaxed"
              />
        ...
        {/* Live AI Prompt Benchmark Simulator */}
        <div className="space-y-6">
          <div className="rounded-2xl p-6 bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 shadow-sm space-y-4 sticky top-24 transition-colors">
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-[11px] font-mono text-slate-800 dark:text-slate-300 space-y-3 max-h-[420px] overflow-y-auto leading-relaxed">
              <div>
                <span className="text-teal-700 dark:text-cyan-400 font-bold"># SENDER_AGENCY:</span>
                <p className="text-slate-900 dark:text-white mt-0.5">{formData.company_name || 'Not Set'}</p>
              </div>
            ...
            <div className="p-3 rounded-xl bg-teal-50 dark:bg-cyan-500/5 border border-teal-200 dark:border-cyan-500/20 text-teal-900 dark:text-slate-300 text-xs flex items-center gap-2">
